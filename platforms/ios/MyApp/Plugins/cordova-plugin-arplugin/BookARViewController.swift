...
class BookARViewController: ViewController, ARSCNViewDelegate, ARSessionDelegate {
    ...
    let anchorInstruction = UILabel(frame: CGRect(x: 125, y: 50, width: 150, height: 30))
  ...
  //  private var anchorsAndContentData: [ARReferenceImage : [UIImage]] = [:]
    ...
    override func viewDidLoad() {
       ...
       // view.addSubview(arView)
        ...
        anchorInstruction.text = "  Find Your Anchor  "
        anchorInstruction.textColor = UIColor.black
