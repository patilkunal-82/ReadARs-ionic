...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUp = function (newuser) {
        var _this = this;
        return this.http.post(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'users/signup', { 'firstname': newuser.firstname, 'lastname': newuser.lastname, 'username': newuser.username, 'password': newuser.password, 'email': newuser.email })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            _this.storeUserCredentials({ username: newuser.username, token: res.token });
...
var ProcessHTTPMsgService = /** @class */ (function () {
    ...
    ProcessHTTPMsgService.prototype.presentToast = function (msg) {
...
/***/ "./src/app/services/readars.service.ts":
/*!*********************************************!*\
  !*** ./src/app/services/readars.service.ts ***!
  \*********************************************/
/*! exports provided: ReadarsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReadarsService", function() { return ReadarsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
...
var ReadarsService = /** @class */ (function () {
    ...
    ReadarsService.prototype.getBooks = function () {
        if (!this.auth.isLoggedIn()) {
            return null;
        }
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'books')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    };
    ReadarsService.prototype.getBook = function (id) {
        if (!this.auth.isLoggedIn()) {
            return null;
        }
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'books/' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    };
    ReadarsService.prototype.getFeaturedBook = function () {
        if (!this.auth.isLoggedIn()) {
            return null;
        }
    ...
    ReadarsService.prototype.getReservedBooks = function () {
        ...
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'books?isReserved=true').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (books) { return books[0]; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    };
    ReadarsService.prototype.getBookIds = function () {
        if (!this.auth.isLoggedIn()) {
            return null;
        }
        return this.getBooks().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (books) { return books.map(function (book) { return book._id; }); }))
    ...
    ReadarsService.prototype.postComment = function (bookId, comment) {
        return this.http.post(_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'books/' + bookId + '/comments', comment)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    };
    ReadarsService.prototype.deleteBook = function (bookId) {
        var _this = this;
        if (!this.auth.isLoggedIn()) {
            return null;
        }
        return this.http.delete(_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'books/' + bookId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) { return _this.processHTTPMsgService.handleError(error); }));
    };
...
/***/ "./src/app/services/searchbooks.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/searchbooks.service.ts ***!
  \*************************************************/
/*! exports provided: SearchedData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_readars_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/readars.service */ "./src/app/services/readars.service.ts");



var SearchedData = /** @class */ (function () {
    function SearchedData(readarsService) {
        var _this = this;
    ...
    SearchedData = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: "root"
        }),
...
module.exports = __webpack_require__(/*! /Users/kunalpatil/PersonalFamily/WorkRelated/Programming/Ionic/ReadARs_Ionic/src/main.ts */"./src/main.ts");
