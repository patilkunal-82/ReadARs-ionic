...
var BookdetailService = /** @class */ (function () {
    function BookdetailService(_httpClient) {
        this._httpClient = _httpClient;
    }
    BookdetailService.prototype.getBook = function (bookID) {
        return this._httpClient.get(API + "/id/" + bookID);
    };
    BookdetailService.prototype.getAllBooks = function () {
        return this._httpClient.get(API);
    };
    BookdetailService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
